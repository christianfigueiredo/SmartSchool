        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Disciplina>()
                .HasData(new List<Disciplina>{
                    ...
                    new Disciplina(2, "Física", 2, 1),
                    new Disciplina(3, "Português", 3, 3),
                    new Disciplina(4, "Inglês", 4, 3),
                    new Disciplina(5, "Programação", 5, 1),
                    new Disciplina(6, "Matemática", 1, 2),
                    new Disciplina(7, "Física", 2, 2),
                    new Disciplina(8, "Português", 3, 3),
                    new Disciplina(9, "Inglês", 4, 1),
                    new Disciplina(10, "Programação", 5, 2)
                });
            
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555",DateTime.Parse("2005-02-12")), 
                    new Aluno(2, 2, "Paula", "Isabela", "3354288",DateTime.Parse("2005-02-12")),
                    new Aluno(3, 3,"Laura", "Antonia", "55668899",DateTime.Parse("2005-02-12")),
                    new Aluno(4,4, "Luiza", "Maria", "6565659",DateTime.Parse("2005-02-12")),
                    ...
                    new Aluno(7,7, "Paulo", "José", "9874512",DateTime.Parse("2005-02-12"))
